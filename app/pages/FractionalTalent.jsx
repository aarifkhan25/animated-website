    ...
    <><section className="w-full  text-white py-0 px-10 md:px-20 lg:px-32">
        <div className="w-full mx-auto flex flex-col justify-between  gap-10">
          ...
          <div className="flex-1">
            ...
            >
              <div className="mb-8">
                <span className="px-4 py-1.5 rounded-full   bg-sky-500/10 text-[#009ded] text-[8px] md:text-[12px] font-jb-mono font-semibold uppercase">
                 The best fractional talent in the world
                </span>
              </div>
            </AnimatedContent>
            ...
            <ScrollReveal baseOpacity={0.1} enableBlur blurStrength={1}   baseRotation={0}>
              ...
              <h2 className="text-3xl md:text-[65px] lg:text-[72px] font-mulish leading-[1] tracking-tight mb-12">
                Build with Pangeans,<br/> grow with Pangea
              </h2>
              {/* Subtext */}
          ...
          {talent?.map((item, i) => (
            ...
            >
              ...
              <div className=" grid h-full gap-5 lg:gap-10  justify-between">
                <div className="">
                  <span className=" text-[#009ded] text-[8px] md:text-xs font-jb-mono font-semibold uppercase tracking-wider ">
